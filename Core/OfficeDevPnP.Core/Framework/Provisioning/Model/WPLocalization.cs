...
namespace OfficeDevPnP.Core.Framework.Provisioning.Model
{
    ...
    /// </summary>
    public partial class WPLocalization : BaseModel, IEquatable<WPLocalization>
    {
        ...
        public WPLocalization()
        {
        }

        public WPLocalization(string cultureName)
        {
        ...
        {
            if (!(obj is WPLocalization))
            {
                return (false);
            }
            return (Equals((WPLocalization)obj));
        }

        public bool Equals(WPLocalization other)
        {
